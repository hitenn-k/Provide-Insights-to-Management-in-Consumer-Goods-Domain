...
WITH x AS (
SELECT
    COUNT(DISTINCT CASE WHEN fiscal_year = 2021 THEN product_code END) AS unique_product_21,
    COUNT(DISTINCT CASE WHEN fiscal_year = 2020 THEN product_code END) AS unique_product_20
